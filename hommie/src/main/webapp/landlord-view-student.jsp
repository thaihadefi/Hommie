...
.contact-button1 {
  /* Add your custom styles for the contact button */
  /* For example: */
  text-align: center;
}
</style>
...
<div class="container-xxl py-5 w-50">
  <div class="container1">
    <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
      <h1 class="mb-5">
        <span class="text-primary text-uppercase">${student.firstName} ${student.lastName}</span>
      </h1>
    </div>
    ...
    <div class="contact-button1">
      <button class="btn btn-primary w-100 py-3" type="submit" href="#">Send message via Hommie</button>
    </div>
  </div>
</div>
